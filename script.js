...
form.addEventListener('submit', function (event) {
  ...
  if (form.checkValidity()) {
    ...
    const from_name = document.querySelector('[name="fullname"]').value;
    ...
    const templateParams = {
      to_name: to_name,
      from_name: from_name,
      message: fullMessage, // Include the sender's email address in the message
    };

    // Use your actual EmailJS service ID, template ID, and user ID
    emailjs.send('service_9o1zwyv', 'template_hbssi9e', templateParams, 'PJQEbBoWThyF3IEgB')
